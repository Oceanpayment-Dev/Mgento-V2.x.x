 ...
 */
namespace Oceanpayment\DCEP\Model;
...
class PaymentMethod extends AbstractMethod
{
    ...
    protected $_formBlockType = 'Oceanpayment\DCEP\Block\Form';
    protected $_infoBlockType = 'Oceanpayment\DCEP\Block\Info';
    ...
    {
        return $this->urlBuilder->getUrl('oceanpaymentdcep/payment/redirect', ['_secure' => true]);
    }
    ...
    public function getCheckoutParameter()
    {
        ...
        //返回地址
        $backUrl           = $this->urlBuilder->getUrl('oceanpaymentdcep/payment/back', ['_secure' => true,'_nosid' => true]);
        //服务器响应地址
        $noticeUrl         = $this->urlBuilder->getUrl('oceanpaymentdcep/payment/notice', ['_secure' => true,'_nosid' => true]);
        //备注
