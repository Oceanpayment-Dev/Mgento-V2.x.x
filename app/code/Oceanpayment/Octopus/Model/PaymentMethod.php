 ...
 */
namespace Oceanpayment\Octopus\Model;
...
{
    const CODE = 'oceanpaymentoctopus';
    ...
    protected $_formBlockType = 'Oceanpayment\Octopus\Block\Form';
    protected $_infoBlockType = 'Oceanpayment\Octopus\Block\Info';
    ...
    {
        return $this->urlBuilder->getUrl('oceanpaymentoctopus/payment/redirect', ['_secure' => true]);
    }
    ...
    public function getCheckoutParameter()
    {
        ...
        //返回地址
        $backUrl           = $this->urlBuilder->getUrl('oceanpaymentoctopus/payment/back', ['_secure' => true,'_nosid' => true]);
        //服务器响应地址
        $noticeUrl         = $this->urlBuilder->getUrl('oceanpaymentoctopus/payment/notice', ['_secure' => true,'_nosid' => true]);
        //备注
