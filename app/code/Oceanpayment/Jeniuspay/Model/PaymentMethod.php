 ...
 */
namespace Oceanpayment\Jeniuspay\Model;
...
{
    const CODE = 'oceanpaymentjeniuspay';
    ...
    protected $_formBlockType = 'Oceanpayment\Jeniuspay\Block\Form';
    protected $_infoBlockType = 'Oceanpayment\Jeniuspay\Block\Info';
    ...
    {
        return $this->urlBuilder->getUrl('oceanpaymentjeniuspay/payment/redirect', ['_secure' => true]);
    }
    ...
    public function getCheckoutParameter()
    {
        ...
        //返回地址
        $backUrl           = $this->urlBuilder->getUrl('oceanpaymentjeniuspay/payment/back', ['_secure' => true,'_nosid' => true]);
        //服务器响应地址
        $noticeUrl         = $this->urlBuilder->getUrl('oceanpaymentjeniuspay/payment/notice', ['_secure' => true,'_nosid' => true]);
        //备注
