 ...
 */
namespace Oceanpayment\Akulaku\Model;
...
{
    const CODE = 'oceanpaymentakulaku';
    ...
    protected $_formBlockType = 'Oceanpayment\Akulaku\Block\Form';
    protected $_infoBlockType = 'Oceanpayment\Akulaku\Block\Info';
    ...
    {
        return $this->urlBuilder->getUrl('oceanpaymentakulaku/payment/redirect', ['_secure' => true]);
    }
    ...
    public function getCheckoutParameter()
    {
        ...
        //返回地址
        $backUrl           = $this->urlBuilder->getUrl('oceanpaymentakulaku/payment/back', ['_secure' => true,'_nosid' => true]);
        //服务器响应地址
        $noticeUrl         = $this->urlBuilder->getUrl('oceanpaymentakulaku/payment/notice', ['_secure' => true,'_nosid' => true]);
        //备注
