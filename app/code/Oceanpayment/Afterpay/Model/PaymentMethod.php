 ...
 */
namespace Oceanpayment\Afterpay\Model;
...
{
    const CODE = 'oceanpaymentafterpay';
    ...
    protected $_formBlockType = 'Oceanpayment\Afterpay\Block\Form';
    protected $_infoBlockType = 'Oceanpayment\Afterpay\Block\Info';
    ...
    {
        return $this->urlBuilder->getUrl('oceanpaymentafterpay/payment/redirect', ['_secure' => true]);
    }
    ...
    public function getCheckoutParameter()
    {
        ...
        //返回地址
        $backUrl           = $this->urlBuilder->getUrl('oceanpaymentafterpay/payment/back', ['_secure' => true,'_nosid' => true]);
        //服务器响应地址
        $noticeUrl         = $this->urlBuilder->getUrl('oceanpaymentafterpay/payment/notice', ['_secure' => true,'_nosid' => true]);
        //备注
