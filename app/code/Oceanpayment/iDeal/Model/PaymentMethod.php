 ...
 */
namespace Oceanpayment\iDeal\Model;
...
class PaymentMethod extends AbstractMethod
{
    ...
    protected $_formBlockType = 'Oceanpayment\iDeal\Block\Form';
    protected $_infoBlockType = 'Oceanpayment\iDeal\Block\Info';
    ...
    {
        return $this->urlBuilder->getUrl('oceanpaymentideal/payment/redirect', ['_secure' => true]);
    }
    ...
    public function getCheckoutParameter()
    {
        ...
        //返回地址
        $backUrl           = $this->urlBuilder->getUrl('oceanpaymentideal/payment/back', ['_secure' => true,'_nosid' => true]);
        //服务器响应地址
        $noticeUrl         = $this->urlBuilder->getUrl('oceanpaymentideal/payment/notice', ['_secure' => true,'_nosid' => true]);
        //备注
