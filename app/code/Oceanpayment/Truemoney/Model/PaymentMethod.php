 ...
 */
namespace Oceanpayment\Truemoney\Model;
...
{
    const CODE = 'oceanpaymenttruemoney';
    ...
    protected $_formBlockType = 'Oceanpayment\Truemoney\Block\Form';
    protected $_infoBlockType = 'Oceanpayment\Truemoney\Block\Info';
    ...
    {
        return $this->urlBuilder->getUrl('oceanpaymenttruemoney/payment/redirect', ['_secure' => true]);
    }
    ...
    public function getCheckoutParameter()
    {
        ...
        //返回地址
        $backUrl           = $this->urlBuilder->getUrl('oceanpaymenttruemoney/payment/back', ['_secure' => true,'_nosid' => true]);
        //服务器响应地址
        $noticeUrl         = $this->urlBuilder->getUrl('oceanpaymenttruemoney/payment/notice', ['_secure' => true,'_nosid' => true]);
        //备注
