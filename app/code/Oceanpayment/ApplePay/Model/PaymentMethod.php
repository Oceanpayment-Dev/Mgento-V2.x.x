...
{
    const CODE = 'oceanpaymentapplepay';
    ...
    protected $_formBlockType = 'Oceanpayment\ApplePay\Block\Form';
    protected $_infoBlockType = 'Oceanpayment\ApplePay\Block\Info';
    ...
    {
        return $this->urlBuilder->getUrl('oceanpaymentapplepay/payment/redirect', ['_secure' => true]);
    }
    ...
    public function getCheckoutParameter()
    {
        ...
        //返回地址
        $backUrl           = $this->urlBuilder->getUrl('oceanpaymentapplepay/payment/back', ['_secure' => true,'_nosid' => true]);
        //服务器响应地址
        $noticeUrl         = $this->urlBuilder->getUrl('oceanpaymentapplepay/payment/notice', ['_secure' => true,'_nosid' => true]);
        //备注
