 ...
 */
namespace Oceanpayment\DANA\Model;
...
class PaymentMethod extends AbstractMethod
{
    ...
    protected $_formBlockType = 'Oceanpayment\DANA\Block\Form';
    protected $_infoBlockType = 'Oceanpayment\DANA\Block\Info';
    ...
    {
        return $this->urlBuilder->getUrl('oceanpaymentdana/payment/redirect', ['_secure' => true]);
    }
    ...
    public function getCheckoutParameter()
    {
        ...
        //返回地址
        $backUrl           = $this->urlBuilder->getUrl('oceanpaymentdana/payment/back', ['_secure' => true,'_nosid' => true]);
        //服务器响应地址
        $noticeUrl         = $this->urlBuilder->getUrl('oceanpaymentdana/payment/notice', ['_secure' => true,'_nosid' => true]);
        //备注
