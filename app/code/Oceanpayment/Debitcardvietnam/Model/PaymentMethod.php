 ...
 */
namespace Oceanpayment\Debitcardvietnam\Model;
...
{
    const CODE = 'oceanpaymentdebitcardvietnam';
    ...
    protected $_formBlockType = 'Oceanpayment\Debitcardvietnam\Block\Form';
    protected $_infoBlockType = 'Oceanpayment\Debitcardvietnam\Block\Info';
    ...
    {
        return $this->urlBuilder->getUrl('oceanpaymentdebitcardvietnam/payment/redirect', ['_secure' => true]);
    }
    ...
    public function getCheckoutParameter()
    {
        ...
        //金额
        $order_amount      = substr($order->getGrandTotal(), -3) == ".00" ? intval($order->getGrandTotal()) : $order->getGrandTotal();
        //账户
        ...
        //支付方式
        $methods           = "VNM_DebitCard";
        //订单号
        $order_number      = $orderIncrementId;  
        //返回地址
        $backUrl           = $this->urlBuilder->getUrl('oceanpaymentdebitcardvietnam/payment/back', ['_secure' => true,'_nosid' => true]);
        //服务器响应地址
        $noticeUrl         = $this->urlBuilder->getUrl('oceanpaymentdebitcardvietnam/payment/notice', ['_secure' => true,'_nosid' => true]);
        //备注
    ...
    function Source(){
        ...
        if($this->isMobile()){           
            //H5
            return 'Debitcardvietnam_Wap';                
        }else{
            //pc
            return 'Debitcardvietnam_Web';
        }
    }
