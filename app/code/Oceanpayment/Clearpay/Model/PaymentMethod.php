 ...
 */
namespace Oceanpayment\Clearpay\Model;
...
{
    const CODE = 'oceanpaymentclearpay';
    ...
    protected $_formBlockType = 'Oceanpayment\Clearpay\Block\Form';
    protected $_infoBlockType = 'Oceanpayment\Clearpay\Block\Info';
    ...
    {
        return $this->urlBuilder->getUrl('oceanpaymentclearpay/payment/redirect', ['_secure' => true]);
    }
    ...
    public function getCheckoutParameter()
    {
        ...
        //返回地址
        $backUrl           = $this->urlBuilder->getUrl('oceanpaymentclearpay/payment/back', ['_secure' => true,'_nosid' => true]);
        //服务器响应地址
        $noticeUrl         = $this->urlBuilder->getUrl('oceanpaymentclearpay/payment/notice', ['_secure' => true,'_nosid' => true]);
        //备注
