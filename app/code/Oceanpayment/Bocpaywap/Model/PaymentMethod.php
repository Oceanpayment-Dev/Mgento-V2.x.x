 ...
 */
namespace Oceanpayment\Bocpaywap\Model;
...
{
    const CODE = 'oceanpaymentbocpaywap';
    ...
    protected $_formBlockType = 'Oceanpayment\Bocpaywap\Block\Form';
    protected $_infoBlockType = 'Oceanpayment\Bocpaywap\Block\Info';
    ...
    {
        return $this->urlBuilder->getUrl('oceanpaymentbocpaywap/payment/redirect', ['_secure' => true]);
    }
    ...
    public function getCheckoutParameter()
    {
        ...
        //返回地址
        $backUrl           = $this->urlBuilder->getUrl('oceanpaymentbocpaywap/payment/back', ['_secure' => true,'_nosid' => true]);
        //服务器响应地址
        $noticeUrl         = $this->urlBuilder->getUrl('oceanpaymentbocpaywap/payment/notice', ['_secure' => true,'_nosid' => true]);
        //备注
