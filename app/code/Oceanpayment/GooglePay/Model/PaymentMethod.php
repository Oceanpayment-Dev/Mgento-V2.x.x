 ...
 */
namespace Oceanpayment\GooglePay\Model;
...
{
    const CODE = 'oceanpaymentgooglepay';
    ...
    protected $_formBlockType = 'Oceanpayment\GooglePay\Block\Form';
    protected $_infoBlockType = 'Oceanpayment\GooglePay\Block\Info';
    ...
    {
        return $this->urlBuilder->getUrl('oceanpaymentgooglepay/payment/redirect', ['_secure' => true]);
    }
    ...
    public function getCheckoutParameter()
    {
        ...
        //返回地址
        $backUrl           = $this->urlBuilder->getUrl('oceanpaymentgooglepay/payment/back', ['_secure' => true,'_nosid' => true]);
        //服务器响应地址
        $noticeUrl         = $this->urlBuilder->getUrl('oceanpaymentgooglepay/payment/notice', ['_secure' => true,'_nosid' => true]);
        //备注
