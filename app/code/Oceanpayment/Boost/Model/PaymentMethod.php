 ...
 */
namespace Oceanpayment\Boost\Model;
...
class PaymentMethod extends AbstractMethod
{
    ...
    protected $_formBlockType = 'Oceanpayment\Boost\Block\Form';
    protected $_infoBlockType = 'Oceanpayment\Boost\Block\Info';
    ...
    {
        return $this->urlBuilder->getUrl('oceanpaymentboost/payment/redirect', ['_secure' => true]);
    }
    ...
    public function getCheckoutParameter()
    {
        ...
        //返回地址
        $backUrl           = $this->urlBuilder->getUrl('oceanpaymentboost/payment/back', ['_secure' => true,'_nosid' => true]);
        //服务器响应地址
        $noticeUrl         = $this->urlBuilder->getUrl('oceanpaymentboost/payment/notice', ['_secure' => true,'_nosid' => true]);
        //备注
