 ...
 */
namespace Oceanpayment\Korewallet\Model;
...
{
    const CODE = 'oceanpaymentkorewallet';
    ...
    protected $_formBlockType = 'Oceanpayment\Korewallet\Block\Form';
    protected $_infoBlockType = 'Oceanpayment\Korewallet\Block\Info';
    ...
    {
        return $this->urlBuilder->getUrl('oceanpaymentkorewallet/payment/redirect', ['_secure' => true]);
    }
    ...
    public function getCheckoutParameter()
    {
        ...
        //返回地址
        $backUrl           = $this->urlBuilder->getUrl('oceanpaymentkorewallet/payment/back', ['_secure' => true,'_nosid' => true]);
        //服务器响应地址
        $noticeUrl         = $this->urlBuilder->getUrl('oceanpaymentkorewallet/payment/notice', ['_secure' => true,'_nosid' => true]);
        //备注
