 ...
 */
namespace Oceanpayment\Korcreditcard\Model;
...
{
    const CODE = 'oceanpaymentkorcreditcard';
    ...
    protected $_formBlockType = 'Oceanpayment\Korcreditcard\Block\Form';
    protected $_infoBlockType = 'Oceanpayment\Korcreditcard\Block\Info';
    ...
    {
        return $this->urlBuilder->getUrl('oceanpaymentkorcreditcard/payment/redirect', ['_secure' => true]);
    }
    ...
    public function getCheckoutParameter()
    {
        ...
        //返回地址
        $backUrl           = $this->urlBuilder->getUrl('oceanpaymentkorcreditcard/payment/back', ['_secure' => true,'_nosid' => true]);
        //服务器响应地址
        $noticeUrl         = $this->urlBuilder->getUrl('oceanpaymentkorcreditcard/payment/notice', ['_secure' => true,'_nosid' => true]);
        //备注
