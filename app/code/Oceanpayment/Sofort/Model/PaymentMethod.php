 ...
 */
namespace Oceanpayment\Sofort\Model;
...
class PaymentMethod extends AbstractMethod
{
    ...
    protected $_formBlockType = 'Oceanpayment\Sofort\Block\Form';
    protected $_infoBlockType = 'Oceanpayment\Sofort\Block\Info';
    ...
    {
        return $this->urlBuilder->getUrl('oceanpaymentsofort/payment/redirect', ['_secure' => true]);
    }
    ...
    public function getCheckoutParameter()
    {
        ...
        //返回地址
        $backUrl           = $this->urlBuilder->getUrl('oceanpaymentsofort/payment/back', ['_secure' => true,'_nosid' => true]);
        //服务器响应地址
        $noticeUrl         = $this->urlBuilder->getUrl('oceanpaymentsofort/payment/notice', ['_secure' => true,'_nosid' => true]);
        //备注
