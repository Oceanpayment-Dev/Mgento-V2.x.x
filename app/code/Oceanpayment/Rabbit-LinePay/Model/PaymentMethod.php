 ...
 */
namespace Oceanpayment\GCash\Model;
...
class PaymentMethod extends AbstractMethod
{
    ...
    protected $_formBlockType = 'Oceanpayment\GCash\Block\Form';
    protected $_infoBlockType = 'Oceanpayment\GCash\Block\Info';
    ...
    {
        return $this->urlBuilder->getUrl('oceanpaymentgcash/payment/redirect', ['_secure' => true]);
    }
    ...
    public function getCheckoutParameter()
    {
        ...
        //返回地址
        $backUrl           = $this->urlBuilder->getUrl('oceanpaymentgcash/payment/back', ['_secure' => true,'_nosid' => true]);
        //服务器响应地址
        $noticeUrl         = $this->urlBuilder->getUrl('oceanpaymentgcash/payment/notice', ['_secure' => true,'_nosid' => true]);
        //备注
