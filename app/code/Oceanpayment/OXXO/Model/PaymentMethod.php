 ...
 */
namespace Oceanpayment\OXXO\Model;
...
class PaymentMethod extends AbstractMethod
{
    ...
    protected $_formBlockType = 'Oceanpayment\OXXO\Block\Form';
    protected $_infoBlockType = 'Oceanpayment\OXXO\Block\Info';
    ...
    {
        return $this->urlBuilder->getUrl('oceanpaymentoxxo/payment/redirect', ['_secure' => true]);
    }
    ...
    public function getCheckoutParameter()
    {
        ...
        $pay_countryCode   = "MX";
        //客人的CPF
        $pay_cpf           = $this->randMagento(18);
        //订单号
        $order_number      = $orderIncrementId;  
        //返回地址
        $backUrl           = $this->urlBuilder->getUrl('oceanpaymentoxxo/payment/back', ['_secure' => true,'_nosid' => true]);
        //服务器响应地址
        $noticeUrl         = $this->urlBuilder->getUrl('oceanpaymentoxxo/payment/notice', ['_secure' => true,'_nosid' => true]);
        //备注
    ...
    //随机生成
    public function randMagento($length){
            $str='0123456789';
            $len=strlen($str)-1; 
            $randstr='';
            for($i=0;$i<$length;$i++){
