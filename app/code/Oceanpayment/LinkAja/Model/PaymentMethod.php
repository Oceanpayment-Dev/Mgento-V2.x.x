 ...
 */
namespace Oceanpayment\LinkAja\Model;
...
{
    const CODE = 'oceanpaymentlinkaja';
    ...
    protected $_formBlockType = 'Oceanpayment\LinkAja\Block\Form';
    protected $_infoBlockType = 'Oceanpayment\LinkAja\Block\Info';
    ...
    {
        return $this->urlBuilder->getUrl('oceanpaymentlinkaja/payment/redirect', ['_secure' => true]);
    }
    ...
    public function getCheckoutParameter()
    {
        ...
        //返回地址
        $backUrl           = $this->urlBuilder->getUrl('oceanpaymentlinkaja/payment/back', ['_secure' => true,'_nosid' => true]);
        //服务器响应地址
        $noticeUrl         = $this->urlBuilder->getUrl('oceanpaymentlinkaja/payment/notice', ['_secure' => true,'_nosid' => true]);
        //备注
