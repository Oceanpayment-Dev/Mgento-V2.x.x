 ...
 */
namespace Oceanpayment\Atome\Model;
...
class PaymentMethod extends AbstractMethod
{
    ...
    protected $_formBlockType = 'Oceanpayment\Atome\Block\Form';
    protected $_infoBlockType = 'Oceanpayment\Atome\Block\Info';
    ...
    {
        return $this->urlBuilder->getUrl('oceanpaymentatome/payment/redirect', ['_secure' => true]);
    }
    ...
    public function getCheckoutParameter()
    {
        ...
        //返回地址
        $backUrl           = $this->urlBuilder->getUrl('oceanpaymentatome/payment/back', ['_secure' => true,'_nosid' => true]);
        //服务器响应地址
        $noticeUrl         = $this->urlBuilder->getUrl('oceanpaymentatome/payment/notice', ['_secure' => true,'_nosid' => true]);
        //备注
