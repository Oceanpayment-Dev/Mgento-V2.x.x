 ...
 */
namespace Oceanpayment\BPI\Model;
...
class PaymentMethod extends AbstractMethod
{
    ...
    protected $_formBlockType = 'Oceanpayment\BPI\Block\Form';
    protected $_infoBlockType = 'Oceanpayment\BPI\Block\Info';
    ...
    {
        return $this->urlBuilder->getUrl('oceanpaymentbpi/payment/redirect', ['_secure' => true]);
    }
    ...
    public function getCheckoutParameter()
    {
        ...
        //返回地址
        $backUrl           = $this->urlBuilder->getUrl('oceanpaymentbpi/payment/back', ['_secure' => true,'_nosid' => true]);
        //服务器响应地址
        $noticeUrl         = $this->urlBuilder->getUrl('oceanpaymentbpi/payment/notice', ['_secure' => true,'_nosid' => true]);
        //备注
