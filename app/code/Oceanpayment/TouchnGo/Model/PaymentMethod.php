 ...
 */
namespace Oceanpayment\TouchnGo\Model;
...
{
    const CODE = 'oceanpaymenttouchngo';
    ...
    protected $_formBlockType = 'Oceanpayment\TouchnGo\Block\Form';
    protected $_infoBlockType = 'Oceanpayment\TouchnGo\Block\Info';
    ...
    {
        return $this->urlBuilder->getUrl('oceanpaymenttouchngo/payment/redirect', ['_secure' => true]);
    }
    ...
    public function getCheckoutParameter()
    {
        ...
        //返回地址
        $backUrl           = $this->urlBuilder->getUrl('oceanpaymenttouchngo/payment/back', ['_secure' => true,'_nosid' => true]);
        //服务器响应地址
        $noticeUrl         = $this->urlBuilder->getUrl('oceanpaymenttouchngo/payment/notice', ['_secure' => true,'_nosid' => true]);
        //备注
