 ...
 */
namespace Oceanpayment\Konbini\Model;
...
{
    const CODE = 'oceanpaymentkonbini';
    ...
    protected $_formBlockType = 'Oceanpayment\Konbini\Block\Form';
    protected $_infoBlockType = 'Oceanpayment\Konbini\Block\Info';
    ...
    {
        return $this->urlBuilder->getUrl('oceanpaymentkonbini/payment/redirect', ['_secure' => true]);
    }
    ...
    public function getCheckoutParameter()
    {
        ...
        //金额
        $order_amount      = ceil($order->getGrandTotal());
        ...
        //返回地址
        $backUrl           = $this->urlBuilder->getUrl('oceanpaymentkonbini/payment/back', ['_secure' => true,'_nosid' => true]);
        //服务器响应地址
        $noticeUrl         = $this->urlBuilder->getUrl('oceanpaymentkonbini/payment/notice', ['_secure' => true,'_nosid' => true]);
        //备注
        $order_notes       = $orderIncrementId;
        //账单人名
        $billing_firstName = substr($this->OceanHtmlSpecialChars($billing->getFirstname()),0,10);
        //账单人姓
        $billing_lastName  = substr($this->OceanHtmlSpecialChars($billing->getLastname()),0,10);
        //账单人email
        $billing_email     = $this->OceanHtmlSpecialChars($order->getCustomerEmail());
        //账单人电话
        $billing_phone     = substr($this->replace_specialChar($billing->getTelephone()),0,11);
        //账单人国家
