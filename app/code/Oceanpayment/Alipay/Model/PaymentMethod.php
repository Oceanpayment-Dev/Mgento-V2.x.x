 ...
 */
namespace Oceanpayment\Alipay\Model;
...
class PaymentMethod extends AbstractMethod
{
    ...
    protected $_formBlockType = 'Oceanpayment\Alipay\Block\Form';
    protected $_infoBlockType = 'Oceanpayment\Alipay\Block\Info';
    ...
    {
        return $this->urlBuilder->getUrl('oceanpaymentalipay/payment/redirect', ['_secure' => true]);
    }
    ...
    public function getCheckoutParameter()
    {
        ...
        //返回地址
        $backUrl           = $this->urlBuilder->getUrl('oceanpaymentalipay/payment/back', ['_secure' => true,'_nosid' => true]);
        //服务器响应地址
        $noticeUrl         = $this->urlBuilder->getUrl('oceanpaymentalipay/payment/notice', ['_secure' => true,'_nosid' => true]);
        //备注
