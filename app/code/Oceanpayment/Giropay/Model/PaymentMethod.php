 ...
 */
namespace Oceanpayment\Giropay\Model;
...
{
    const CODE = 'oceanpaymentgiropay';
    ...
    protected $_formBlockType = 'Oceanpayment\Giropay\Block\Form';
    protected $_infoBlockType = 'Oceanpayment\Giropay\Block\Info';
    ...
    {
        return $this->urlBuilder->getUrl('oceanpaymentgiropay/payment/redirect', ['_secure' => true]);
    }
    ...
    public function getCheckoutParameter()
    {
        ...
        //返回地址
        $backUrl           = $this->urlBuilder->getUrl('oceanpaymentgiropay/payment/back', ['_secure' => true,'_nosid' => true]);
        //服务器响应地址
        $noticeUrl         = $this->urlBuilder->getUrl('oceanpaymentgiropay/payment/notice', ['_secure' => true,'_nosid' => true]);
        //备注
