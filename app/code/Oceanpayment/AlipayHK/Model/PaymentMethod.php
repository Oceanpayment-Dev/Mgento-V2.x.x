 ...
 */
namespace Oceanpayment\AlipayHK\Model;
...
{
    const CODE = 'oceanpaymentalipayhk';
    ...
    protected $_formBlockType = 'Oceanpayment\AlipayHK\Block\Form';
    protected $_infoBlockType = 'Oceanpayment\AlipayHK\Block\Info';
    ...
    {
        return $this->urlBuilder->getUrl('oceanpaymentalipayhk/payment/redirect', ['_secure' => true]);
    }
    ...
    public function getCheckoutParameter()
    {
        ...
        //返回地址
        $backUrl           = $this->urlBuilder->getUrl('oceanpaymentalipayhk/payment/back', ['_secure' => true,'_nosid' => true]);
        //服务器响应地址
        $noticeUrl         = $this->urlBuilder->getUrl('oceanpaymentalipayhk/payment/notice', ['_secure' => true,'_nosid' => true]);
        //备注
